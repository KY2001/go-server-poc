...
![UI](https://storage.cloud.google.com/go-server-poc.appspot.com/echo.png) 
...
- Support for using Cloud SQL as the database is available on the [cloud-sql branch](https://github.com/KY2001/go-server-poc/pull/1).
- Support for using [Firebase](https://firebase.google.com/) for authentication/authorization is available in the [auth branch](https://github.com/KY2001/go-server-poc/pull/2).
